    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="Image/pic.jpg" alt="First slide">
         </div>
        <div class="item">
          <img class="second-slide" src="Image/home.jpg" alt="Second slide">
        </div>
        <div class="item">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <img class="img-circle" src="Image/payment.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Payment Detials</h2>
          
          <p><a class="btn btn-primary" href="payment.jsp" role="button">Enter details &raquo;</a></p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <img class="img-circle" src="Image/vechile.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Vechile Maintenance</h2>
          <p><a class="btn btn-primary" href="VechileMaintenance.jsp" role="button">Enter details &raquo;</a></p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <img class="img-circle" src="Image/report.png" alt="Generic placeholder image" width="140" height="140">
          <h2>Maintanence Report</h2>
          <p><a class="btn btn-primary" href="Report.jsp" role="button">Generate Report &raquo;</a></p>
        </div>
      </div>
</div>
