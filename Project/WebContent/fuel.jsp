...
if(flag.equals("valid")){
	...
	<div class="row">
		<div class="form-title">
			<span>Fuel Detials is Updated Successfully</span>
		</div>
	</div>
	</div>
<%}
	...
	<div class="row">
		<div class="form-title">
			<span>Vechile No Doesn't Exist</span>
		</div>
	</div>
	</div>
	<%
...
<form action="FuelController" method="get">
			...
			<div class="row">
				...
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input No Of KiloMeter."> </span>
						<input type="text" placeholder="No Of KiloMeters"  Required name=Km >
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Date"> </span>
						<input type="text" placeholder="Date of filling"  Required name=date id="date" >
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input No of Liters"> </span>
						<input type="text" placeholder="Liter"  Required name=Liter >
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Amount"> </span>
