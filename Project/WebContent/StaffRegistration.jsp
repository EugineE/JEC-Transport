...
if(flag.equals("valid")){
	...
	<div class="row">
		<div class="form-title">
			<span>Staff is registered successfully</span>
		</div>
	</div>
	</div>
<%}
	...
	<div id="login-form" class="form-container" data-form-container style="color: rgb(198, 40, 40); background: rgb(255, 205, 210);">
			<div class="row">
				<div class="form-title">
					<span>Invalid StaffId or BoardingPoint</span>
				</div>
			</div>
			</div>
<%
...
<!End status>
<!form>
<form action="StaffRegistrationController" method="get">
			...
			<div class="input-container">
				<div class="row">
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Staff Name."> </span>
						<input type="text" Required placeholder="Full Name" name=name>
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Staff Id No."> </span>
						<input type="text" placeholder="Staff Id" Required name=staffid>
					</span>
				</div>
				
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Staff Department."> </span>
						<input type="text" placeholder="Department" list="department" Required name=department>
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Staff Boarding Point."> </span>
						<input type="text" placeholder="Boarding Point" list="boardingPoint" Required name=boardingPoint>
					</span>
				</div>
