...
if(flag.equals("valid")){
	...
	<div class="row">
		<div class="form-title">
			<span>Road Tax Detials is Updated Successfully</span>
		</div>
	</div>
	</div>
<%}
...
<!End status>
<!form>
<form action="RoadtaxController" method="get">
			<div id="contact-form" class="form-container" data-form-container>
			<div class="row">
				<div class="form-title">
					<span>Road Tax Detials</span>
				</div>
			</div>
			<div class="input-container">
				...
				<div class="row">
					<span class="req-input">
						...
						<input type="text" placeholder="Next Road Tax Date"  Required name=roadtaxDate id="date">
					</span>
				</div>
				<div class="row">
					<span class="req-input">
...
String sql="select * from roadtax where roadtax_date<'"+new java.sql.Date(date.getTime())+"' and status='false';";
