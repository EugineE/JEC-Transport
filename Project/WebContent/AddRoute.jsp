...
if(flag.equals("valid")){
	...
	<div class="row">
		<div class="form-title">
			<span>Boarding Point is Added successfully</span>
		</div>
	</div>
	</div>
<%}
...
<!form>
<form action="AddRouteController" method="get">
			...
			<div class="input-container">
				<div class="row">
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Bus No."> </span>
						<input type="text"  placeholder="Bus NO" name="BusNo" Required>
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input New Bus Boarding Point."> </span>
						<input type="text" placeholder="Boarding Point" name=boardingPoint Required>
					</span>
				</div>
				<div class="row submit-row">
				     
					<button type="submit" class="btn btn-block submit-form" >Add Boarding Point</button>
				</div>
			</div>
			</div>
			</form>
