...
if(flag.equals("valid")){
	...
	<div class="row">
		<div class="form-title">
			<span>FC Detials is Updated Successfully</span>
		</div>
	</div>
	</div>
<%}
			...
			<div class="input-container">
				...
				<div class="row">
					<span class="req-input">
						...
						<input type="text" placeholder="Next FC Date"  Required name=FcDate id="date">
					</span>
				</div>
				<div class="row">
					<span class="req-input">
...
String sql="select * from fc where fc_date<'"+new java.sql.Date(date.getTime())+"' and status='false';";
