...
<form action="ReportController" method="get">
			...
			<div class="input-container">
				...
				<div class="row">
						...
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Report Type."> </span>
						<input type="text" Required placeholder="Report Type"  name=reportType list="reportType">
					</span>
				</div>
				<div class="row">
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Report Vechile Number."> </span>
						<input type="text"  placeholder="Vechile NO"  name=vechileNo list="vechileNo" >
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Report Vechile Type."> </span>
						<input type="text" placeholder="Vechile Type"   name=vechileType list="vechileType">
					</span>
				</div>
				
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Report Start Date."> </span>
						<input type="text" placeholder="Report Start Date"  Required name=start id="date">
					</span>
				</div>
				...
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Report Start Date."> </span>
						<input type="text" placeholder="Report End Date"  Required name=end id="date1">
					</span>
				</div>
...
String sql="select * from vechile_detials;";
